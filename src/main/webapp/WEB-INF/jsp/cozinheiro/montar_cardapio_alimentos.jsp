                ...
                <div class="col-xs-12">
                    <form action="<c:url value='/cadastrar_produto'/>" method="post" class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select name="produto.tipoProduto" class="form-control">
                                  ...
                                  <option value="Almoco">Almoçoo</option>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <textarea class="form-control" rows="5" name="produto.descricao" placeholder="Descrição do produto"></textarea>
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="valor_unitario" class="col-sm-2 control-label">* Valor unitário:</label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" name="produto.valor" placeholder="Valor unitário">
                        </div>
                      </div>
