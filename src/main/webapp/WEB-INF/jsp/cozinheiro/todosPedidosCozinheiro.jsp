        ...
        <nav class="navbar navbar-inverse navbar-fixed-top">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<c:url value='/painelCozinheiro'/>"><i class="fa fa-cutlery" aria-hidden="true"></i> Burguer Soft</a>
                </div>
            ...
            <div class="row">
                <div class="col-sm-3 col-md-2 sidebar">
                    <ul class="nav nav-sidebar">
                        ...
                        <li><a href="<c:url value='/painelCozinheiro'/>"><i class="fa fa-chevron-left" aria-hidden="true"></i> Voltar</a></li>
                    </ul>
