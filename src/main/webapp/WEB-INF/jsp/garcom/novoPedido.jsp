			...
			<div class="container-fluid">
				...
				<div id="navbar" class="navbar-collapse collapse">
					<ul class="nav navbar-nav navbar-right">
						<li>
							<a>Usuário: ${usuario.funcionario.nome}</a>
						</li>
						<li>
							<a href="${linkTo[IndexController].logout}">Sair</a>
						</li>
					</ul>
				</div>
			</div>
									...
									<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
										<div class="panel panel-default">
											<div class="panel-heading" role="tab" id="heading-${status.index}">
												<h4 class="panel-title"><a role="button" data-toggle="collapse" href="#collapse-${status.index}" aria-expanded="false"
												aria-controls="collapse-${status.index}"> ${map.key.nome} </a></h4>
											</div>
														...
														<tbody>
															<c:forEach var="produto" items="${map.value}">
																<tr>
																	...
																	<label>
																		<input type="checkbox" name="itens[].produto.codigo" value="${produto.codigo}" class="sel-produto">
																		${produto.descricao} - valor ${produto.valor} - unidade </label></td>
																	<td>
						...
						<div class="form-group">
							<div class="col-sm-offset-2 col-sm-10">
								<button type="submit" class="btn btn-primary">
									<i class="fa fa-shopping-cart" aria-hidden="true"></i> Montar pedido
								</button>
							</div>
						</div>
					</form>
