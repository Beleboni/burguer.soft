...
public class IndexController {
	...
	@Inject
	public IndexController(Result result, Validator validator, UsuarioSessao usuarioSessao) {
		this.result = result;
	...
	public void confereUsuario(String usuario, String senha) {
		...
		validator.check(funcionario != null, new SimpleMessage("usuario", "Usuário inválido"));
		validator.check(funcionario != null && funcionario.verificaUsuario(senha), new SimpleMessage("senha", "Senha inválida"));
